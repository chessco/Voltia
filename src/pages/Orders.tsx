...
const columns = [
  { id: 'pending', title: 'Pedidos Pendientes', count: 4, color: 'bg-orange-500' },
  { id: 'review', title: 'En Revisión', count: 2, color: 'bg-blue-500' },
  { id: 'completed', title: 'Completados Hoy', count: 8, color: 'bg-green-500' }
];

const orders = [
  { id: 'ORD-001', customer: 'Subestación Industrial A', amount: 12500, status: 'pending', time: 'hace 2h', priority: 'Alta' },
  { id: 'ORD-002', customer: 'Complejo Comercial B', amount: 8400, status: 'review', time: 'hace 4h', priority: 'Media' },
  { id: 'ORD-003', customer: 'Finca Residencial C', amount: 3200, status: 'pending', time: 'hace 1d', priority: 'Baja' },
  { id: 'ORD-004', customer: 'Expansión de Fábrica D', amount: 45000, status: 'completed', time: 'hace 1h', priority: 'Alta' },
  { id: 'ORD-005', customer: 'Torre de Oficinas E', amount: 15600, status: 'completed', time: 'hace 3h', priority: 'Media' }
];
  ...
  return (
    <div className="space-y-10">
      <header className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Flujo de Pedidos</h1>
          <p className="text-gray-500 mt-1">Gestione y rastree sus pedidos de infraestructura eléctrica.</p>
        </div>
                ...
                <div key={order.id} className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-gray-200/50 transition-all cursor-pointer group">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className={cn(
                      ...
                      order.priority === 'Alta' ? "bg-red-50 text-red-600" : 
                      order.priority === 'Media' ? "bg-orange-50 text-orange-600" : "bg-blue-50 text-blue-600"
                    )}>
