...
const steps = [
  { id: 1, title: 'Tipo de Proyecto', description: 'Seleccione el alcance de su proyecto' },
  { id: 2, title: 'Detalles del Proyecto', description: 'Proporcione requisitos específicos' },
  { id: 3, title: 'Revisar y Enviar', description: 'Confirme su solicitud' }
];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 py-10">
      <header className="text-center space-y-4">
        <h1 className="text-4xl font-black text-gray-900 uppercase tracking-tighter italic">Asistente de Cotización de Proyecto</h1>
        <p className="text-gray-500 text-lg max-w-2xl mx-auto">Nuestro equipo técnico proporcionará una estimación completa basada en sus necesidades específicas de infraestructura.</p>
      </header>
      ...
      <div className="bg-white rounded-[40px] border border-gray-100 shadow-2xl shadow-gray-200/50 p-12 min-h-[500px] flex flex-col">
        <AnimatePresence mode="wait">
          {currentStep === 1 && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-2xl font-black text-gray-900 uppercase tracking-tight italic">Seleccionar Tipo de Proyecto</h3>
                <p className="text-gray-500">Elija la categoría que mejor se adapte a sus necesidades de infraestructura.</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  { id: 'Industrial', icon: Warehouse, label: 'Industrial', desc: 'Fábricas, Subestaciones, Plantas' },
                  { id: 'Commercial', icon: Building2, label: 'Comercial', desc: 'Oficinas, Centros Comerciales, Hospitales' },
                  { id: 'Residential', icon: Home, label: 'Residencial', desc: 'Apartamentos, Complejos, Fincas' }
                ].map((type) => (
                  <button
                    key={type.id}
          ...
          {currentStep === 2 && (
            ...
            >
              <div className="space-y-2">
                <h3 className="text-2xl font-black text-gray-900 uppercase tracking-tight italic">Detalles del Proyecto</h3>
                <p className="text-gray-500">Proporcione información específica para una cotización más precisa.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input 
                    type="text" 
                    placeholder="ej. Expansión de Subestación A" 
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all font-bold appearance-none">
                    <option>Inmediato (1-3 meses)</option>
                    <option>Mediano Plazo (3-6 meses)</option>
                    <option>Largo Plazo (6+ meses)</option>
                    <option>Fase de Planificación</option>
                  </select>
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-black text-gray-400 uppercase tracking-widest flex items-center gap-2">
                  ...
                  <div className="flex gap-2">
                    {['Baja', 'Media', 'Alta'].map((p) => (
                      <button key={p} className="flex-1 py-4 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold text-gray-500 hover:bg-white hover:border-orange-200 hover:text-orange-500 transition-all">
                        {p}
                      </button>
                    ))}
                  </div>
          ...
          {currentStep === 3 && (
            ...
            >
              ...
              <div className="space-y-2">
                <h3 className="text-3xl font-black text-gray-900 uppercase tracking-tight italic">Listo para Enviar</h3>
                <p className="text-gray-500 max-w-md">Revise toda la información antes de enviar su solicitud. Nuestro equipo técnico se pondrá en contacto con usted en un plazo de 24-48 horas.</p>
              </div>
              ...
              <div className="w-full max-w-md bg-gray-50 rounded-3xl p-8 text-left space-y-4 border border-gray-100">
                ...
                <div className="flex justify-between border-b border-gray-200 pb-4">
                  ...
                  <span className="text-sm font-black text-gray-900 uppercase italic">Expansión de Subestación A</span>
                </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 flex items-center justify-between">
          ...
          <button 
            onClick={nextStep}
            className="px-10 py-4 bg-orange-500 text-white rounded-2xl font-black uppercase tracking-widest italic hover:bg-orange-600 transition-all shadow-xl shadow-orange-500/30 flex items-center gap-3 group"
          >
